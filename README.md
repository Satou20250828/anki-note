...
<img src="docs/demo.gif" alt="暗記ノートの動作デモ（暗記・穴埋め・キーワードの3モード切り替えと隠す/表示）" width="800" />
...
- **Next.js 16（App Router）**
  - 選定理由: 画面の作成だけでなく、ページ遷移やサーバー側の処理までまとめて実装できるため。また、Vercelとの相性がよく、アプリを公開しやすい点も理由。
- **React 19**
  - 選定理由: 画面を部品（コンポーネント）単位で分けて作れるため、後から機能を追加・修正しやすいと考えたため。
- **TypeScript**
  - 選定理由: データの間違いを開発中に見つけやすく、実行前にミスを減らせるため。
- **Tailwind CSS**
